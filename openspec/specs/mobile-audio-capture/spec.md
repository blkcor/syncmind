# mobile-audio-capture Specification

## Purpose

Defines US-044 mobile voice capture from the paired Capture screen, including voice-mode entry, microphone permission handling, recording profile, press-and-hold lifecycle, encrypted audio payload creation, local limits, and interruption handling.
