# mobile-photo-capture Specification

## Purpose

Defines US-045 mobile photo capture from the paired Capture screen, including camera and library source selection, image permission gates, JPEG preprocessing, local size limits, optional captions, encrypted `capture-image` payload creation, and outbox enqueue behavior.
