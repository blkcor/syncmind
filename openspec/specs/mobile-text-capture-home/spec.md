# mobile-text-capture-home Specification

## Purpose

Defines the paired mobile app's default text capture home screen, including input focus, connection status, send eligibility, keyboard dismissal, and latest local capture metadata.
